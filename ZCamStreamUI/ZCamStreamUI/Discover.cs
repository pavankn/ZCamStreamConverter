...
namespace com.khelai.ZCamStreamUI
{
    class Mdns
    {
        ...
        ///
        private static List<String> discoveredDevices= new List<string>();
        public static async Task<List<string>> Discover(bool linkLocalOnly = false,
            ...
            )
        {
            ...
            QueryTimer.Start();
            PrintTimer = new System.Timers.Timer(500);
        ...
        private static void MDns_AnswerReceived(object sender, MessageEventArgs e)
        {
            ...
            if (DisplayIPv4)
            {
                if (ipv4s.Count() > 0)
                {
                    ...
                    {
                        output += ip.Address + " ";
                        discoveredDevices.Add(ip.Address.ToString());
                    }
                }
                else
                {
        ...
        private static System.Timers.Timer PrintTimer;
    }
}
